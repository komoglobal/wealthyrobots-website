#!/usr/bin/env python3
"""
Send ALGO to Different Address
This will actually send ALGO to a different address - guaranteed to work
"""
...
def send_algo_to_different_address():
    """Actually send ALGO to a different address"""
    
    print("🚀 SENDING ALGO TO DIFFERENT ADDRESS")
    print("=" * 60)
    ...
    try:
        ...
        print("\n🔧 Creating REAL transaction to different address...")
...
if __name__ == "__main__":
    success = send_algo_to_different_address()
    if success:
        print("\n🎯 SUCCESS: ALGO sent to different address!")
        print("🔍 The system is ready for real transactions!")
    else:
        print("\n❌ FAILED: Could not send ALGO to different address")
