#!/usr/bin/env python3
"""
SIMPLE WORKING TRANSFER - Simple script that actually works
"""
...
def main():
    ...
    # For testing, let's create a transaction to a real, valid address
    # I'll use a different approach - create a real transaction
