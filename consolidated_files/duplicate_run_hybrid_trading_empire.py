...
ENABLE_ASA_EXPANSION = False  # DISABLED: Low ALGO balance
...
def build_tinyman_fixed_input_swap(clients: Dict[str, Any], sender_addr: str, sender_sk: bytes,
    ...
    try:
        # Use SDK manager for robust imports
        if not is_sdk_available('tinyman'):
            print("⚠️ Tinyman SDK not available, using fallback")
            return {'ok': False, 'error': 'Tinyman SDK not available'}
