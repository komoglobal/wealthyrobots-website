#!/usr/bin/env python3
"""
HEALTHCARE_AGENT - Implement healthcare_agent agent
...
class HealthcareAgentAgent:
    """
    Implement healthcare_agent agent
    """

    def __init__(self, workspace_path: str = "/home/ubuntu/wealthyrobot"):
        self.workspace_path = Path(workspace_path)
        self.agent_name = "healthcare_agent"
        self.capabilities = []
